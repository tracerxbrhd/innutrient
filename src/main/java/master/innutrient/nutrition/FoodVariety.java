...
public final class FoodVariety {
    ...
    public static Result consume(Identifier previousFood, int previousRepeats, long previousGameTime,
                                 Identifier consumedFood, long gameTime, double penaltyPerRepeat,
    ...
    public record Result(double efficiency, Identifier food, int repeatCount, long gameTime) {}
}
