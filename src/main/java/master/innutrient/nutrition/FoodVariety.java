...
public final class FoodVariety {
    ...
    public static Score score(List<DietMemoryEntry> memory, long gameTime, long freshnessWindowTicks,
                              Set<ResourceLocation> requiredGroups, int sampleTarget) {
        ...
        Map<ResourceLocation, Integer> foodFrequency = new HashMap<>();
        Set<Long> compositions = new HashSet<>();
        Set<ResourceLocation> observedGroups = new HashSet<>();
        ...
        Set<ResourceLocation> targets = requiredGroups == null ? Set.of() : requiredGroups;
        int coveredGroups;
